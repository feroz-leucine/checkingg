...
<body>
				...
				<div class="container-fluid mw-100">
					...
					<div
						...
						<div
							...
							<h4 class="fw-semibold mb-0">Actions</h4>
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb mb-0">
									<li class="breadcrumb-item"><a
										class="text-muted text-decoration-none" href="/dashboard.jsp">Home</a></li>
									<li class="breadcrumb-item"><a
										class="text-muted text-decoration-none" href="#">Actions</a></li>
								</ol>
							</nav>
						</div>
					</div>
	...
	<script
		src="/assets/js/extra-libs/jvectormap/jquery-jvectormap-us-aea-en.js"></script>
</body>
